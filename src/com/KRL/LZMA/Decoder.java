...
public class Decoder
{
	class LenDecoder
	{
		...
		public void Init()
		{
			com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_Choice);
		...
		public int Decode(com.KRL.LZMA.RangeCoderDecoder rangeDecoder, int posState) throws IOException
		{
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public void Init()
			{
				com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_Decoders);
			}

			public byte DecodeNormal(com.KRL.LZMA.RangeCoderDecoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(com.KRL.LZMA.RangeCoderDecoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
	...
	com.KRL.LZMA.RangeCoderDecoder	m_RangeDecoder			= new com.KRL.LZMA.RangeCoderDecoder();
	...
	void Init() throws IOException
	{
		...
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsMatchDecoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsRep0LongDecoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsRepDecoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsRepG0Decoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsRepG1Decoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_IsRepG2Decoders);
		com.KRL.LZMA.RangeCoderDecoder.InitBitModels(m_PosDecoders);
