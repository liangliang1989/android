...
public class DataOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(createSql(tables.ecgTable()));
		...
		db.execSQL(createSql(tables.oneOldChildTable()));
		db.execSQL(createSql(tables.twoOldChildTable()));
		...
		db.execSQL(createSql(HealthCheckTable.healthCheckTableDesc()));
